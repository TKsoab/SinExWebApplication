...
namespace SinExWebApp20317887.Controllers
{
    public class PackageTypeSizesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PackageTypeSizeID,info,PackageTypeID")] PackageTypeSize packageTypeSize)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PackageTypeSizeID,info,PackageTypeID")] PackageTypeSize packageTypeSize)
        {
            if (ModelState.IsValid)
            {
